...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Promise.allSettled([
    ...
    loadScriptOnce(siteRoot + "assets/js/site-theme.js?v=5"),
    ...
    loadScriptOnce(siteRoot + "assets/js/feature-lists.js?v=4"),
    loadScriptOnce(siteRoot + "assets/js/faqs.js?v=1"),
